		...
		try {
			...
			if (!empty($Userid)) {
				...
				if (count($levelview) > 0) {
					...
					$levels = $levels->select('tu1.id', 'tu2.id as down_id', 'tu1.user_id as user_id', 'tu2.user_id as down_user_id', 'tu2.fullname as down_fullname', 'tu3.user_id as sponser_id', 'cn.country', 'tu2.fullname', 'tu2.entry_time', 'tu2.status', 'td.coin', 'td.btc', 'td.total_investment', 'td.total_withdraw', 'td.total_profit', 'tlv.level','tpt.srno', 'tpt.id', 'tpt.topupfrom', 'tpt.pin', 
