...
//            return sendResponse($arrStatus, $arrCode, $arrMessage, '');
        ...
        if ($otpdata['status'] == 200)
        {
            ...
            try {
                ...
                if (!empty($request->Input('trn_address')))
                {
                    ...
                    $flag = 2;
                        $addDataC['currency'] = "TRX";
                        $addDataC['id'] = Auth::user()->id;
                        $addDataC['currency_address'] = trim($request->Input('trn_address'));
                        ...
                        }else if($addBTCStatus->currency_address != trim($request->Input('trn_address'))){
                            $updateAddress['block_user_date_time'] = $new_time;
                            $updateAddress['token'] = $token;
                            $updateAddress['token_status'] = 0;
                            $updateAddress['currency_address'] = trim($request->Input('trn_address'));
                ...
                if (!empty($request->Input('ethereum')))
                {
                    ...
                    $flag = 2;
                        $addDataC['currency'] = "ETH";
                        $addDataC['id'] = Auth::user()->id;
                        $addDataC['currency_address'] = trim($request->Input('ethereum'));
                        $addDataC['ip_address'] = $_SERVER['REMOTE_ADDR'];
                        $addBTCStatus = UserWithdrwalSetting::where([['id',Auth::user()->id],['currency',$addDataC['currency']],['status',1]])->first();
                ...
                if (!empty($request->Input('usdt_erc20_address')))
                {
                    ...
                    $flag = 2;
                        $addDataC['currency'] = "USDT-ERC20";
                        $addDataC['id'] = Auth::user()->id;
                        $addDataC['currency_address'] = trim($request->Input('usdt_erc20_address'));
                        $addDataC['ip_address'] = $_SERVER['REMOTE_ADDR'];
                        $addBTCStatus = UserWithdrwalSetting::where([['id',Auth::user()->id],['currency',$addDataC['currency']],['status',1]])->first();
                ...
                if (!empty($request->Input('bnb_address')))
                {
                    ...
                    $flag = 2;
                        $addDataC['currency'] = "BNB";
                        $addDataC['id'] = Auth::user()->id;
                        $addDataC['currency_address'] = trim($request->Input('bnb_address'));
                        $addDataC['ip_address'] = $_SERVER['REMOTE_ADDR'];
                        $addBTCStatus = UserWithdrwalSetting::where([['id',Auth::user()->id],['currency',$addDataC['currency']],['status',1]])->first();
                        ...
                        }else if($addBTCStatus->currency_address != trim($request->Input('bnb_address'))){
                            $updateAddress['block_user_date_time'] = $new_time;
                            $updateAddress['token'] = $token;
                            $updateAddress['token_status'] = 0;
                ...
                if (!empty($request->Input('btc_address')))
                {
                    $arrData['btc_address'] = trim($request->Input('btc_address'));
                        ...
                        $flag = 2;
                        $addDataC['currency'] = "BTC";
                        $addDataC['id'] = Auth::user()->id;
                        $addDataC['currency_address'] = trim($request->Input('btc_address'));
                        $addDataC['ip_address'] = $_SERVER['REMOTE_ADDR'];
                        $addBTCStatus = UserWithdrwalSetting::where([['id',Auth::user()->id],['currency',$addDataC['currency']],['status',1]])->first();
                ...
                if (!empty($request->Input('ltc_address')))
                {
                    $arrData['ltc_address'] = trim($request->Input('ltc_address'));
                        $flag = 2;
                        $addDataC['currency'] = "LTC";
                        $addDataC['id'] = Auth::user()->id;
                        $addDataC['currency_address'] = trim($request->Input('ltc_address'));
                        $addDataC['ip_address'] = $_SERVER['REMOTE_ADDR'];
                        $addBTCStatus = UserWithdrwalSetting::where([['id',Auth::user()->id],['currency',$addDataC['currency']],['status',1]])->first();
                ...
                if (!empty($request->Input('doge_address')))
                {
                    $arrData['doge_address'] = trim($request->Input('doge_address'));
                        $flag = 2;
                        $addDataC['currency'] = "DOGE";
                        $addDataC['id'] = Auth::user()->id;
                        $addDataC['currency_address'] = trim($request->Input('doge_address'));
                        $addDataC['ip_address'] = $_SERVER['REMOTE_ADDR'];
                        $addBTCStatus = UserWithdrwalSetting::where([['id',Auth::user()->id],['currency',$addDataC['currency']],['status',1]])->first();
                ...
                if (!empty($request->Input('sol_address')))
                {
                    $arrData['sol_address'] = trim($request->Input('sol_address'));
                        $flag = 2;
                        $addDataC['currency'] = "SOL";
                        $addDataC['id'] = Auth::user()->id;
                        $addDataC['currency_address'] = trim($request->Input('sol_address'));
                        $addDataC['ip_address'] = $_SERVER['REMOTE_ADDR'];
                        $addBTCStatus = UserWithdrwalSetting::where([['id',Auth::user()->id],['currency',$addDataC['currency']],['status',1]])->first();
                ...
                if (!empty($request->Input('usdt_trc20_address')))
                {
                    ...
                    $flag = 2;
                        $addDataC['currency'] = "USDT-TRC20";
                        $addDataC['id'] = Auth::user()->id;
                        $addDataC['currency_address'] = trim($request->Input('usdt_trc20_address'));
                        $addDataC['ip_address'] = $_SERVER['REMOTE_ADDR'];
                        $addBTCStatus = UserWithdrwalSetting::where([['id',Auth::user()->id],['currency',$addDataC['currency']],['status',1]])->first();
    ...
    public function updateUserDataOld(Request $request)
    {
		 ...
		 */
         ...
         $arrInput['user_id'] = Auth::user()->id;
         $arrInput['otp'] = $request->input('otp');
