...
class FundRequestController extends Controller
{
    ...
    public function fundRequestBlade(Request $request){

        return view('admin.AddFund.index');
    ...
    public function fundRequest(Request $request)
    {
        ...
        if (!empty($userExist)) {
            ...
            $fundRequest->user_id = $request->id;
            ...
            $dash = Dashboard::where('id', $request->id)->first();
            // $update = Dashboard::where('id', $request->user_id)->update(['top_up_wallet' => $dash->top_up_wallet + $request->amount]);
            $update = Dashboard::where('id', $request->id)->update(['fund_wallet' => $dash->fund_wallet + $request->amount]);
    ...
    public function fundremoveBlade(Request $request){

        return view('admin.AddFund.removeFund');
    ...
    public function transferReportBlade(){
        return view('admin.Transfer.TransferReportComponent');
    }

    public function AdminAddFundReportBlade(){
        return view('admin.AddFund.AddFundReport');
    }

    public function AdminRemoveFundReportBlade(){
        return view('admin.AddFund.RemoveFundReport');
    }
