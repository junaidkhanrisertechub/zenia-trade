...
class PowerUptoParticularId extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cron:addpower_uptoparticular_level';
     ...
     * @var string
     */
    protected $description = 'This Cron Add Power Upto Particular Level';
    ...
    {
        $this->manageCronController->AddPowerUptoParticularLevel(); 
    }
}
