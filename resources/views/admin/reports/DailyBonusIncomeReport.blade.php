        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Daily Bonus Income Report</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
            ...
            setTimeout(function() {
                const table = $("#binary-income-report").DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            render: function(data, type, row) {
                                return "<span>$" + row.daliy_binary_income + "</span>";
                            }
                        },
                        {
                            render: function(data, type, row) {
                                return "<span>" + row.daily_binary_pin + "</span>";
                            }
                        },
                        {
                            render: function(data, type, row) {
                        ...
                        {
                            render: function(data, type, row) {
                                return "<span>" + row.daliy_percentage + "</span>";
                            }
                        },
                    ],
                });
        ...
        function exportToExcel() {
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    fileLink.setAttribute('download', 'Daily-Bonus-Income-Report.xls');
