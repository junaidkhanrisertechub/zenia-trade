                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Pin</label>
                                                <input class="admin-form-control" placeholder="Enter pin" type="text"
                                                    id="pin" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
    ...
    $(document).ready(function() {
        ...
        var reportsTable = $("#binary-income-report").DataTable({
            ...
            columns: [{
                ...
                // {
                //   render: function (data, type, row) {
                //     if (row.remark==' ' || row.remark === null || row.remark === undefined || row.remark === "")
                //     {
                //       return `<span>-</span>`;
                //     }
                //     else {
