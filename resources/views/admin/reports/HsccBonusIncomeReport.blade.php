        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Hscc BONUS Income Report</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
            ...
            setTimeout(function() {
                const table = $("#binary-income-report").DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            render: function(data, type, row) {
                                return "<span>" + row.daily_percentage + "</span>";
                            }
                        },
                        {
                            render: function(data, type, row) {
                        ...
                        },
                        {
                            render: function(data, type, row) {
                                ...
                                if (row.status === "Active") {
                                    ...
                                    labelStatus = "<b>PAID</b>";
                                } else {
                                    labelClass = "text-danger";
                                    labelStatus = "UNPAID";
                                }
                                return (
                                    '<label class="' + labelClass + ' waves-effect">' +
                                    labelStatus + "</label>"
                                );
                            },
                        },
            ...
            $.ajax({
                ...
                success: function(resp) {
                    if (resp.code === 200) {
                        ...
                        fileLink.setAttribute("download", "HSCC-Bonus-Income-Report.xls");
