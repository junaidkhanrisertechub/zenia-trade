...
<head>
   <title>HSCC | Successfully purchased a plan for another member</title>
                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <p style="color:#fff !important;">You have Successfully purchased a '.$product_type.' package worth '.$amount.' USD from your Member ID: '.$username.' for Member ID: '.$downline_username.' on '.$date.'.</p>

                              <p style="color:#fff !important;">Order Number: '.$pin.'</p>
                              <p style="color:#fff !important;">Plan Name: '.$product_type.' - '.$product_range.' </p>
                              <p style="color:#fff !important;">Daily ROI: $'.$daily_roi.' </p>
