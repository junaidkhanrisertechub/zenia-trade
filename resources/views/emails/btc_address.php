                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <p style="color:#fff !important;">Did you try to change the Bitcoin Address in your account?
                                 If Yes, use the below code to proceed.<br> ' . $code . '.
                              </p>
                           </div>
                        </td>
                     </tr>
