                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p style="color:#fff !important;">Member ID: '.$username.', '.$name.' just purchased a plan for your Member ID: '.$downline_username.' on '.$date.'. </p>
                              <p style="color:#fff !important;">Miner Name: '.$product_type.' - '.$product_range.' </p>
