...
<head>
   <title>HSCC | Referral Income Weekly Report</title>
                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p> Your Referral Income Weekly Report is ready.</p>

                             <p>Get an overview of your earnings and see how you can improve your performance. We are always here to help.</p>


                             <p>Total Referral Income in last week: $'.$weekly_referral_income.'</p>
                     ...
                     <tr>
                        <td>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">     <span style="color:#f13613;font-size:20px">Please Note</span><br>                          
                            Shoot your questions and concerns to <a href="href:support@thehscc.co.uk" style="color:#000;">support@thehscc.co.uk</a> and you’ll immediately hear from us!
                           </h6>
                        </td>
                        <!--  <td>
