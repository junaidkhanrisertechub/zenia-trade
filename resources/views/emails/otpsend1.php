          ...
          <table align="center" width="100%">
            <tbody style="background: #000;padding:0 50px">
              <tr>
                ...
                <td>
                  <h1 style="font-size: 24px;font-weight: 600;">Dear '.$username.'! </h1>
                </td>
                <td>
                  <p style="font-size:16px;color: #fff;line-height: 24px;">Did you try to change the Bitcoin Address in your account?<br>
If Yes, use the below code to proceed.</p>
                </td>
                <td>
                    <div style="background:#EB292B;width:200px;text-align:center;margin: 0 auto !important;padding:5px">
                    <p style=" color: #fff;font-size: 20px;font-weight: bold;margin: 10px;">' . $otp . ' </p>
                  </div>
                </td>
              </tr>
            </tbody>
            ...
            <tbody style="background: #ffffff;padding:30px">
              <tr>
                ...
                <td>
                  ...
                  <p style="font-size: 12px;line-height: 24px;">Please get in touch with our support team at: <b>support@dfgsdfg.com.</b>
                  </p>
        ...
        <td>
          <ul style="list-style: none;margin: 0;padding: 7px 0;background: #EB292B;border-radius: 0 0 12px 12px;">
            ...
            <li style="display: inline-block;font-size: 20px;color: #fff;">
              <img src="' . $envelope . '">
              <a href="mailto:'.$mail.'" target="_blank" style="color: #fff;text-decoration: none;">support@hscc.com</a>
            </li>
          </ul>
        </td>
      </tr>
