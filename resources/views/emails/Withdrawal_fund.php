...
<head>
   <title>HSCC | Withdraw request has been submitted successfully</title>
                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <p style="color:#fff !important;"> Request ID: '.$username.' </p>
                              <p style="color:#fff !important;">Withdrawal From: '.$withdraw_from.' </p>
                              <p style="color:#fff !important;">Withdrawal to Wallet Address: '.$wallet_address.' </p>
                              <p style="color:#fff !important;">Request Date: '.$date.' </p>
                              <p style="color:#fff !important;">Withdrawal Amount: '.$withdraw_amount.' USD </p>
                              <p style="color:#fff !important;">Withdrawal Fees: '.$fees.' USD </p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
                     ...
                     <tr>
                        <td>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">
                              ...
                              <br>If this was not done by you, contact <a href="href:support@thehscc.co.uk" style="color:#000;">support@thehscc.co.uk</a>
                           </h6>
                        </td>
                        <!--  <td>
