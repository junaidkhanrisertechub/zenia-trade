...
<head>
   <title>Welcome to HSCC! Your Registration is Complete</title>
               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                           <h1 style="font-size: 24px;font-weight: 600;margin-bottom: 0px;">Hi, ' .$name. '</h1>
                        </td>
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">

                              <p style="color:#fff !important;"> We are thrilled to have you as a member of HSCC. We are a community of like-minded individuals who believe in revolutionising the Crypto Arbitrage space all around the globe. </p>

                              <p style="color:#fff !important;">We would like to take this opportunity to confirm that your registration process has been completed successfully. You are now a fully registered member of HSCC. </p>

                              <p style="color:#fff !important;"> Your login credentials are as follows: </p>

                              <p style="color:#fff !important;"> User ID: ' .$username. ' </p>
                              <p style="color:#fff !important;">Password: '.$password.' </p>
                              <p style="color:#fff !important;">Email address:  '.$email.' </p>
                              <p style="color:#fff !important;">With your registration, you will have access to our exclusive members-only Backoffice where you can add funds and make an investment to start earning every day. </p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
      ...
      <tbody>
                     ...
                     <tr>
                        <td>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">
                              If you have any questions or need assistance, please do not hesitate to reach out to us at <a href="href:support@thehscc.co.uk" style="color:#000;">support@thehscc.co.uk</a> . Our support team will be happy to assist you.
                           </h6>
                        </td>
                        <!--  <td>
         ...
         <tr style="background:#000;margin:8px 20px;
            ...
            <td style="display:flex;flex-direction: row;position: relative;">
               <p style="font-size: 16px;line-height: 25px; color:#fff;>
                  <span style="font-weight: bold;font-size: 22px;margin: 0;">Cheers!</span>
                  <br> Thank you for choosing HSCC. We look forward to your continued growth with our community. <br> Regards, <b>HSCC</b> <br>
