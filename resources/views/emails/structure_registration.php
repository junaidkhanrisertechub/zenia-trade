...
<head>
   <title>HSCC | Structure Creation Mail</title>
                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              ...
                              <div style="text-align:center;color: #ffffff;border: 2px solid #000000;width:80%;margin:0px auto;padding:10px 0px;border-radius: 10px;"> <strong> Your login details : </strong> <br>
                                 <span style="padding: 5px 0px;text-align: center; display: -webkit-inline-box;margin: 5px;line-height: 27px;font-size: 18px;color: #ffffff;width: 96%;text-align: center;display: block;margin: 8px auto 0px auto;font-weight: 800;"> No. of IDs in structure : ' .$no_of_id. ' <br> Password : ' .$password. ' <br>
                                 Email: '.$user_email.'</span>
                              </div>
                              <p style="text-align:center;color: #ffffff;">
                                 <span style="font-size: 14px;font-weight: 600;color: #ffffff;text-transform: uppercase;"> DO NOT SHARE YOUR LOGIN DETAILS WITH ANYONE.</span>
                                 <br> <br>
                                 You can login here: <a href="'.$domainname.'" target="_blank" style="color: #fff; text-decoration: none;">&nbsp;"'.$domainname.'"</a> <br>
                                 Thank you.<br>
                              </p>
                           </div>
                        </td>
