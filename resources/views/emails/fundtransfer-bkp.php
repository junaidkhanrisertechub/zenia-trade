          ...
          <table align="center" width="100%">
            <tbody style="background: #000;padding:0 50px">
              <tr>
                ...
                <td>
                  <h1 style="font-size: 24px;font-weight: 600;">Hello' .$from_userId.'</h1>
                </td>                
               <td>
                  <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">


                  <p style=" color: #fff;font-size: 18px;font-weight: bold;margin: 10px;">This is to inform you that <strong>'.$fund.'</strong> has been transferred from your account associated with Username: <strong> '.$from_userId.' to </strong> another account associated with Username: <strong>'.$touserId.'</strong>
                  </p>
                  </div>
                </td>
                  <td>
                  <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                    <p style=" color: #fff;font-size: 18px;font-weight: bold;margin: 10px;">
                     '.$content.'</p>
                  </div>
                </td>
