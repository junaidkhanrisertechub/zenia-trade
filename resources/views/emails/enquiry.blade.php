                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <p style="color: #fff; margin: 10px 0; line-height: 1.6; text-align: left">Fullname 
                                 : ' . $fullname . ' 
                              </p>
                              <p style="color: #fff; margin: 10px 0; line-height: 1.6; text-align: left"> Email: ' . $email . ' </p>
                              <p style="color: #fff; margin: 10px 0; line-height: 1.6; text-align: left">Message:
                                 ' . $msg . ' 
                              </p>
                           </div>
                        </td>
