...
<head>
   <title>HSCC | Your profile has been updated.</title>
                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p>We are happy to let you know that your profile ('.$username.') has been updated </p>

                             <p style="color:#fff !important;"> Old Details: '.$old_data_content.' </p>
                              <p style="color:#fff !important;">New Details: '.$new_data_content.' </p>
                              <p style="color:#fff !important;">Thanks for being a part of our community. </p>
                              <p style="color:#fff !important;">You can view and edit your profile at any time. </p>
                     ...
                     <tr>
                        <td>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">
                              ...
                              If you did not initiate this action, your account may be compromised. Please contact our support team immediately at <a href="href:support@thehscc.co.uk" style="color:#000;">support@thehscc.co.uk</a> or reach out to us through our social media channels for assistance.
                           </h6>
                        </td>
                        <!--  <td>
