...
<head>
   <title>HSCC | Your HSCC Account Password has been Changed</title>
                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p style="color:#fff !important;">This is to inform you that the password for your HSCC account '.$user_id.' associated with this email address has been successfully changed. </p>

                              <p style="color:#fff !important;">If you initiated this change, then no further action is required. Your account is now secure with the new password.</p>

                              <p style="color:#fff !important;">If you did not initiate this change, please contact our support team immediately at <a href="href:support@thehscc.co.uk" style="color:#000;">support@thehscc.co.uk</a> . Our team will assist you in resolving this issue and protecting your account.</p>

                              <p style="color:#fff !important;">We highly recommend that you keep your account password secure and change it periodically for security reasons.</p>
         ...
         <tr style="background:#000;margin:8px 20px;
            ...
            <td style="display:flex;flex-direction: row;position: relative;">
               <p style="font-size: 16px;line-height: 25px;">
                  ...
                  <br> HSCC is an investment company that aims to enhance its user’s financial stability and offer them easy and reliable solutions to depend on, for their economic growth. <br> Thank you for choosing HSCC.   <br> Regards, <b>HSCC</b> <br>
