...
<head>
  <title>Registration OTP Mail</title>
          ...
          <table align="center" width="100%">
            <tbody style="background: #000;padding:0 50px">
              <tr>
                ...
                <td>
                  <p style="font-size:16px;color: #fff;line-height: 24px;">Did you try to create your new account ?<br> If Yes, use the below code to proceed.</p>
