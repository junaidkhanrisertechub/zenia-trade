...
<head>
   <title>HSCC | Binary Income Weekly Report</title>
               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                            <h1 style="font-size: 24px;font-weight: 600;margin-bottom: 0px;">Hello, ' .$username. '</h1>
                           
                        </td>
                        
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p style="color:#fff !important;">Welcome back to our weekly Binary income report!</p>

                             <p style="color:#fff !important;">Total Binary Income in last week: $'.$weekly_binary_income.'</p>


                             <p style="color:#fff !important;">It is our hope that this report serves as a valuable resource, offering a comprehensive overview of your earnings and providing insightful suggestions for enhancing your performance.</p>
            ...
            <td>
               <table align="center" width="100%">
                  <tbody style="background: #ffffff;padding:30px">
                     <tr>
                        <td>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">We are always here to help, so if you have any questions or concerns, please dont hesitate to reach out! 
                           </h6>
                        </td>
                        <!--  <td>
                           <p style="font-size: 16px;line-height: 24px;font-weight: bold;">
                             <span style="display: block;color: #000;font-weight: bold;font-size: 25px;">IMPORTANT</span> If there is any error in your login credentials or <br> you’d like to change your login details.
                           </p>
