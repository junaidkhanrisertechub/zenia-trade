...
<head>
   <title>HSCC | Funds Available in your Fund Wallet. Invest to start getting ROI </title>
               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                            <h1 style="font-size: 24px;font-weight: 600;margin-bottom: 0px;">Psst!</h1>
                            <h1 style="font-size: 24px;font-weight: 600;margin-top: 0px">Hey '.$username.', </h1>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p style="color:#fff !important;">Are you forgetting something?? We noticed that you recently added Funds to your wallet but did not complete the purchase. ROI will not start until you have purchased a plan.</p>

                             <p style="color:#fff !important;">Is there anything we can do to help? Coz now is the time to buy your plan and start earning every day.</p>
                     ...
                     <tr>
                        <td>
                            <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">
                              ...
                              <br>Feel free to reply to this email with any queries you may have.
                           </h6>
                        </td>
                        <!--  <td>
