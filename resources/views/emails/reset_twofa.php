...
<head>
   <title>HSCC | Reset Your Google 2FA for your HSCC Account '.$username.'</title>
                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p style="color:#fff !important;">We received a request to reset the Google 2FA for your HSCC account ' .$username. '. If you did not initiate this request, please ignore this email.</p>

                              <p style="color:#fff !important;">To reset your Google 2FA, please follow the link below:<br> 
                                 <a href="'.$path.'" target="_blank" style="color:fff;    background: #5c5b5bf7;
    padding: 4px 10px;
    border-radius: 2px;
    color: #fff;
}" >Click Here >></a></p>
                                 <p style="color:#fff !important;">If the link does not work, you can copy and paste the URL into your browser. This link will be active for 5 minutes.</p>
