                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <p style="color:#fff !important;">We wanted to inform you that the Google Two-Factor Authentication (2FA) linked with your account ' .$username. ' has been successfully removed.</p>
                              <p style="color:#fff !important;">Please keep in mind that removing Google 2FA may reduce the security of your account. We highly recommend that you consider enabling 2FA again in the future to add an extra layer of protection to your account.</p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
