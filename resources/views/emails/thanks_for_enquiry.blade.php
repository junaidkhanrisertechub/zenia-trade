...
//$rocket = $message->embed(public_path() . '/user_files/images/rocket.png');
                  ...
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        <td>
                           ...
                           <img src="' . $logo . '" style="margin-top:10px" width="270">
                        </td>
                        <td>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <h6 style="color: #fff;font-size: 16px;line-height: 24px;margin: 10px 0;">
                                 <br> We appreciate your reaching out to us. We are pleased to assist you. We will respond to you right away.
                              </h6>
                              <p style="font-size: 16px;line-height: 24px;font-weight: bold;">
                                 <span style="display: block;color: #fff;font-weight: bold;font-size: 25px;">Thank you</span>Regards
                              </p>
                              <p style="font-weight:600;font-size:20px;text-align:center;line-height: 24px;">HSCC Admin Team</p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
            ...
            <td>
               <table align="center" width="100%">
                  <tbody style="background: #ffffff;padding:30px">
                     <tr>
                        <td>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">     <span style="color:#f13613;font-size:20px">Please Note</span><br>                          
                              If this was not done by you, contact <a href="href:support@thehscc.co.uk" style="color:#000;">support@thehscc.co.uk</a>
                           </h6>
                        </td>
                        <!--  <td>
                           <p style="font-size: 16px;line-height: 24px;font-weight: bold;">
