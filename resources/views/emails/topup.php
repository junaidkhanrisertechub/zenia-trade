...
$envelope = $message->embed(public_path() . '/images/envelope.png');
$phone = $message->embed(public_path() . '/images/mobile.png');
...
<head>
   <title>Purchase Mail | HSCC | HSCC VIP plan purchased Successfully </title>
                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <p style="color:#fff !important;">We’re glad to have you onboard.</p>
                              <p style="color:#fff !important;">You successfully purchased a plan worth '.$amount.' USD from your User ID: '.$username.' on '.$date.'.</p>
                              <p style="color:#fff !important;">Order Number: '.$pin.'</p>
                              <p style="color:#fff !important;">Plan Name: '.$product_type.' - '.$product_range.' </p>
                              <p style="color:#fff !important;">Your Daily ROI: $'.$daily_roi.' </p>
                              <p style="color:#fff !important;">Maximum Benefit: $'.$max_benefit.' or 10x Capping </p>
                              <p style="color:#fff !important;">Plan Validity: '.$validity_date.' or 10x Capping </p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
                     ...
                     <tr>
                        <td>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">
                              ...
                              <br> Dates are displayed as per Coordinated Universal Time. <br> Order dates may vary based on your location.
                           </h6>
                        </td>
                        <!--  <td>
         ...
         <tr style="background:#000;margin:8px 20px;
            ...
            <td style="display:flex;flex-direction: row;position: relative;">
               <p style="font-size: 16px;line-height: 25px;">
                  ...
                  <a href="" style="font-size: 12px;margin: 0;color: #fff;">www.thehscc.co.uk</a>
               </p>
