...
<head>
   <title>HSCC | Fund Received to your HSCC account.</title>
                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p style="color:#fff !important;">We are pleased to inform you that your transfer of '.$fund.' USD from your Member ID: '.$from_userId.' to Member ID: '.$touserId.' on '.$date.' went through without a hitch!</p>
                              <p style="color:#fff !important;">Thanks for choosing HSCC.</p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
