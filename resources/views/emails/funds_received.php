...
<head>
   <title>HSCC | Fund Transfer Successful</title>
               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                           <h1 style="font-size: 24px;font-weight: 600;margin-bottom: 0px;">Dear ' .$reciever_name. '</h1>
                        </td>
                        <td>
                        </td>
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p style="color:#fff !important;">We are pleased to inform you that your HSCC account has been credited with '.$fund.' USD from Member ID: '.$from_userId.' on '.$date.'.</p>
                              <p style="color:#fff !important;">Your updated '.$wallet_type.' wallet balance is:  '.$reciever_new_balance.'</p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
                     ...
                     <tr>
                        <td>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">
                              ...
                              <br>If this was not meant for you, contact <a href="href:support@thehscc.co.uk" style="color:#000;">support@thehscc.co.uk</a>
                           </h6>
                        </td>
                        <!--  <td>
