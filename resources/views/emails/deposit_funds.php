...
<head>
   <title>Successful deposit to HSCC account</title>
               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                           <h1 style="font-size: 24px;font-weight: 600;margin-bottom: 0px;">Hey ' .$name. '</h1>
                        </td>
                       
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p style="color:#fff !important;">We are happy to confirm that your HSCC account ('.$username.') is credited successfully. Transaction ID: '.$invoice_id.'. You should be able to see the funds in your account shortly.</p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
