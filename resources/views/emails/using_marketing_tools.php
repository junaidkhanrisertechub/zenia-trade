...
<head>
   <title>HSCC | Get yourself armed with HSCC Marketing Tools.</title>
               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                            <h1 style="font-size: 24px;font-weight: 600;margin-bottom: 0px;">Greetings '.$username.', </h1>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p style="color:#fff !important;"> We hope you are having a great day! We wanted to send you a quick email to share with you our kickass marketing tools.</p>

                             <p style="color:#fff !important;">To access our remarkable marketing tools, log in to your account and navigate to the Marketing Tools option in the side menu.</p>


                             <p style="color:#fff !important;">Use them to promote your referral links on other platforms and expand your network.</p>
            ...
            <td>
               <table align="center" width="100%">
                  <tbody style="background: #ffffff;padding:30px">
                     <tr>
                        <td>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">    Get started now and earn with HSCC!
                           </h6>
                        </td>
                        <!--  <td>
         ...
         <tr style="background:#000;margin:8px 20px;
            ...
            <td style="display:flex;flex-direction: row;position: relative;">
               <p style="font-size: 16px;line-height: 25px;">
                  ...
                  <br> HSCC is an investment company that aims to enhance its user’s financial stability and offer them easy and reliable solutions to depend on, for their economic growth. <br> Thank you, <b>HSCC</b> <br>
