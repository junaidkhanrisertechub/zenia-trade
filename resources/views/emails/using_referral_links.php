...
<head>
   <title>HSCC | Here is your HSCC referral link</title>
               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                            <h1 style="font-size: 24px;font-weight: 600;margin-bottom: 0px;"> Hola  ' .$username. '</h1>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             ...
                             <p style="color:#fff !important;"> We are here to give you another cool way to earn some extra money!</p>

                             <p style="color:#fff !important;">Now you can refer your friends and family to start earning passive income through Binary, Referral and HSCC bonuses.</p>


                             <p style="color:#fff !important;">For this to work, all you have to do is copy your referral link and share it with your family and friends. Yes, it is that simple and guess what? Its free!</p>

                             <p style="color:#fff !important;">So, what are you waiting for?? <a href="'.$domain_link.'" style="color:#fff">Click here</a> to get started.</p>
