          ...
          <table align="center" width="100%">
            <tbody style="background: #000;padding:0 50px">
              <tr>
                ...
                <td>
                  <h1 style="font-size: 24px;font-weight: 600;color:#fff">Password Reset Successfully</h1>
                </td>
                <td>
                  <p style="font-size:16px;color: #fff;line-height: 24px;">Thank you for using password recovery option. .<br>
If Yes, use the below code to proceed.</p>
                </td>
                <td>
                    <p style="color: #ffffff;margin: 10px 0;line-height: 1.6;text-align: center;">'.$project_name.'</p>
             <p style="color: #ffffff;margin: 10px 0;line-height: 1.6;text-align: left;text-align: center;">
        ...
        <td>
          <table align="center" width="100%">
            <tbody style="background: #ffffff;padding:30px">
              <tr>
                <td>
                <p style="color: #000;text-decoration: none                           !important;border-bottom: none;font-weight:600">
