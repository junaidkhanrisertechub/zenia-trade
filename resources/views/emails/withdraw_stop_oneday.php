                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <p style="font-size:16px;color: #fff;line-height: 24px;">'.$contant.'</p>
                              <p style="font-size:16px;color: #fff;line-height: 24px;">'.$sub_contant.' <a href="'.$prof_url.'" target="_blank" style="color:#fff;">'.$click_here.'</a></p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
