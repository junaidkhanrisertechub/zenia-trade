               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:max-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <p style="font-size:16px;color: #fff;line-height: 24px;">Did you try to change the Password of your account?<br>
                                 If Yes, click on the following link to update your password<br> and follow the simple steps
                              </p>
                              <p> Your login details : </p>
                              <a href="'.$path.'/public/user#/reset-password?resettoken=' . $reset_token . '" style="text-align: center;
                                 text-decoration: none;
                                 color: #fff;
                                 padding: 10px;
                                 display: inline-block;
                                 border-radius: 13px;
                                 background: #484848;">Click Here..</a>
                           </div>
                        </td>
                     </tr>
                  </tbody>
