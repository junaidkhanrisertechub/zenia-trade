                  ...
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                           ...
                           <p> We are thrilled to have you as a member of HSCC. We are a community of like-minded individuals who believe in revolutionising the Crypto Arbitrage space all around the globe.

                              <p>We would like to take this opportunity to confirm that your registration process has been completed successfully. You are now a fully registered member of HSCC.

                             <p> Your login credentials are as follows: </p>
                             <p> User ID: </p>
                              <p>Password: </p>
                              <p>Email address:  demmy@me.com </p>
                              <p>With your registration, you will have access to our exclusive members-only Backoffice where you can add funds and make an investment to start earning every day. </p>
