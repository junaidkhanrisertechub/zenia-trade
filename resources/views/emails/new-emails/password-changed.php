               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                            <h1 style="font-size: 24px;font-weight: 600;margin-bottom: 0px;">Hi, ' .$username. '</h1>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p>This is to inform you that the password for your HSCC account << User ID>> associated with this email address has been successfully changed. </p>

                              <p>If you initiated this change, then no further action is required. Your account is now secure with the new password.</p>

                              <p>If you did not initiate this change, please contact our support team immediately at <a href="href:support@thehscc.co.uk" style="color:#000;">support@thehscc.co.uk</a> . Our team will assist you in resolving this issue and protecting your account.</p>

                              <p>We highly recommend that you keep your account password secure and change it periodically for security reasons.</p>
