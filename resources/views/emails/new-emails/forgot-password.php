...
<head>
   <title>HSCC | Reset Your Password for your HSCC Account << User ID >></title>
                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p>We received a request to reset the password for your HSCC account ' .$userid. '. If you did not initiate this request, please ignore this email.</p>

                              <p>To reset your password, please follow the link below: <br> 
                                 <a href="#" style="color:fff;">[Password reset link]</a></p>
                                 <p>If the link does not work, you can copy and paste the URL into your browser. This link will be active for [time period, e.g. 24 hours].</p>
