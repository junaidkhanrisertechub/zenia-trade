...
<head>
   <title>HSCC | {A new post, a new Information} </title>
               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                            <h1 style="font-size: 24px;font-weight: 600;margin-bottom: 0px;">Hey ' .$username. '</h1>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p> We are so glad you stopped by. We have got something new for you today, and we hope you will take a minute to check it out. <a href="#" style="color:#fff;">(Link to the article)</a> </p>

                             <p>We have a blog page where we keep updating new updates from the industry. We found this article insightful and we hope you find time to read it too.</p>

                             <p>Link As Follow : <a href="#" style="color:#fff;">{link to article}</a></p>
