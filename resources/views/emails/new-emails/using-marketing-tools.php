               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                            <h1 style="font-size: 24px;font-weight: 600;margin-bottom: 0px;">Greetings {recipient name},  ' .$username. '</h1>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p> We hope you are having a great day! We wanted to send you a quick email to share with you our kickass marketing tools.</p>

                             <p>To access our remarkable marketing tools, log in to your account and navigate to the Marketing Tools option in the side menu.</p>


                             <p>Use them to promote your referral links on other platforms and expand your network.</p>
