...
<head>
   <title>HSCC | Withdrawal request processed successfully </title>
               ...
               <table align="center" width="100%">
                  <tbody style="background: #000;padding:0 50px">
                     <tr>
                        ...
                        <td>
                            <h1 style="font-size: 24px;font-weight: 600;margin-bottom: 0px;">Dear ' .$username. '</h1>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <p>KACHING! The sound of money sure does feel good!</p>
                             <p> Just wanted to let you know that your withdrawal request has been processed successfully and your funds will be available in your account shortly. </p>
                              <p>Request ID: << 437626 >> </p>
                              <p>Withdrawal From << ROI Wallet >> </p> 
                             <p> Withdrawal to Wallet Address: <<149q2hcWMmsf3WZNw84QBwsQswMSJAZKTP>> </p>
                              <p>Request Date: << 16 Jul 2022 >> </p>
                              <p>Withdrawal Amount: << 10 USD >> </p>
                              <p>Withdrawal Fees: <<1 USD >> </p>
                     ...
                     <tr>
                        <td>
                            <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">
                              ...
                              <br>If you have any questions, please dont hesitate to contact us at <a href="href:support@thehscc.co.uk" style="color:#000;">support@thehscc.co.uk</a>
                           </h6>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">                              
