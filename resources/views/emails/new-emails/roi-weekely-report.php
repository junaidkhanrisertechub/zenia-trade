                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p>Here is your weekly ROI income report. </p>
                              <p>Weekly ROI from **/**/**** till **/**/**** </p>
                              <p>Member ID: <**********> for Order No. <**********>: <<$100>> </p>
            ...
            <td>
               <table align="center" width="100%">
                  <tbody style="background: #ffffff;padding:30px">
                     <tr>
                        <td>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">We are always here to help so if you have any questions or concerns, please don not hesitate to reach out!
                           </h6>
                        </td>
                        <!--  <td>
