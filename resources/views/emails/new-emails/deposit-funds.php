                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                             <p>We are happy to confirm that your HSCC account (123456789) is credited successfully. {Transaction ID}). You should be able to see the funds in your account shortly.</p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
