...
<head>
   <title>HSCC | Your HSCC Accounts Google 2FA has Been Removed</title>
                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <p>We wanted to inform you that the Google Two-Factor Authentication (2FA) linked with your account ' .$userid. ' has been successfully removed.</p>
                              <p>Please keep in mind that removing Google 2FA may reduce the security of your account. We highly recommend that you consider enabling 2FA again in the future to add an extra layer of protection to your account.</p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
                     ...
                     <tr>
                        <td>
                           <h6 style="color: #000;font-size: 16px;line-height: 24px;margin: 10px 0;">
                              If you have any questions or need assistance with 2FA, please do not hesitate to reach out to us at <a href="href:support@thehscc.co.uk" style="color:#000;">support@thehscc.co.uk</a>. Our support team will be happy to assist you.
                           </h6>
                        </td>
                        <!--  <td>
            ...
            <td>
               <ul style="list-style: none;margin: 0;padding: 7px 0;background: #EB292B;border-radius: 0 0 12px 12px;">
                  <li style="display: inline-block;font-size: 20px;color: #fff;margin-right: 40px;">
                     <img src="https://www.thehscc.co.uk/images/mobile.png">
                  ...
                  <li style="display: inline-block;font-size: 20px;color: #fff;">
                     <img src="https://www.thehscc.co.uk/images/envelope.png">
