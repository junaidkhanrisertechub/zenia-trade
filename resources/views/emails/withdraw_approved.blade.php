                     ...
                     <tr>
                        ...
                        <td>
                           <div style="background:#EB292B;width:fit-content;text-align:center;margin: 0 auto !important;padding:5px">
                              <p style="font-size:16px;color: #fff;line-height: 24px;"> Your withdrawal request has been approved.<br> Your funds will be duly deposited in your account within the stipulated period of time. </p>
                           </div>
                        </td>
                     </tr>
                  </tbody>
            ...
            <td>
               <ul style="list-style: none;margin: 0;padding: 7px 0;background: #EB292B;border-radius: 0 0 12px 12px;">
                  ...
                  <li style="display: inline-block;font-size: 20px;color: #fff;">
                     <img src="' . $envelope . '">
                     <a href="'.$mail.'" target="_blank" style="color: #fff;text-decoration: none;">'.$mail.'</a>
                  </li>
               </ul>
            </td>
         </tr>
