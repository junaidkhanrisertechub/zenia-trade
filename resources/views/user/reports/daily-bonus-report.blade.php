...
@section('content')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header justify-content-between d-flex align-items-center">
                                <h4 class="card-title">Daily Bonus Report</h4>
                            </div>
                            <!-- end card header -->
                                    ...
                                    <form id="searchForm">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Pin</label>
                                                    <input type="text" class="form-control" name="user_id" id="pin"
                                                        placeholder="Pin" />
                                                </div>
                                            </div>
                            ...
                            <div class="card-body">
                                <div id="table-gridjs">
                                    <div class="table-responsive">
                                        <table v-once id="daily-bonus-report" class="display nowrap table-striped"
                                            style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th>Sr No.</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var topUpTable = $('#daily-bonus-report').DataTable({
                processing: true,
                serverSide: true,
                order: [0, 'ASC'],
                dom: 'lrtip',
                buttons: [],
                ajax: "{{ url('/reports/daily-bonus-data') }}",
                "columns": [
                    ...
                    {
                        data: 'daliy_binary_income',
                        name: 'daliy_binary_income',
                        orderable: false,
                        searchable: false
                    },
                    {
                    ...
                    {
                        data: 'daily_binary_pin',
                        name: 'daily_binary_pin',
                        orderable: false,
                        searchable: false
                    },
                    {
                    ...
                    {
                        data: 'daliy_percentage',
                        name: 'daliy_percentage',
                        orderable: false,
                        searchable: true
                    },
                    {
