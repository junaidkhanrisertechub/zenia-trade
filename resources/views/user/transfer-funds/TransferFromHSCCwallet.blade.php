                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb ms-3">
                        <h6 class="font-weight-bolder mb-0">
                            Transfer from HSCC BONUS Wallet
                        </h6>
                    </nav>
                </div>
            </div> --}}
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header justify-content-between d-flex align-items-center">
                                <h4 class="card-title">Transfer from BONUS Wallet</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <form class="row g-3" method="post">
                                                ...
                                                <div class="col-md-12 d-flex justify-content-center">
                                                    <button class="btn btn-primary w-50 text-uppercase p-2"
                                                        type="button" onclick="sendOTP()" disabled id="topupsub">
                                                        Submit
                                                    </button>
                                                </div>
                                            </form>
    ...
    function saveForm() {
        ...
        if (currentOTP == '') {
            ...
            $.ajax({
                ...
                url: "{{ url('/store-transferfromhsccwallet') }}",
                type: 'POST',
                headers: {
