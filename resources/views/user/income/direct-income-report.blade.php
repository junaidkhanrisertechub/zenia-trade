            ...
            <div class="col-md-12">
              ...
              <li class="breadcrumb-item text-sm text-dark active" aria-current="page">
                Affiliate Income
                    ...
                    <h6 class="font-weight-bolder mb-0">Direct Income</h6>
                </nav>
            </div>
        </div>
        <div class="row mt-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="user-id" id="user-id" placeholder="From User Id" />
                        ...
                        <div class="table-responsive">
                            <table v-once id="structure-balance-receive" class="display nowrap table-striped" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <td>{{ $data->from_user_id }}</td>
                                    <td>{{ $data->amount }}</td>
                                    <td>{{ $data->laps_amount }}</td>
                                    <td>{{ $data->remark }}</td>
                                    <td>
                                        @if( $data->status == "Paid")
                                            <span class="bg-success text-light px-4 py-2">Paid</span>
                                        @else
                                            <span class="bg-gradient-primary px-4 py-2">Unpaid</span>
                                        @endif
                                    </td>
                                    @endforeach
                                </tbody>
