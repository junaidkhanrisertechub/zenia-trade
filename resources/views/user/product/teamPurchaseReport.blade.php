...
@section('content')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header justify-content-between d-flex align-items-center">
                                <h4 class="card-title">Team Purchase Report</h4>
                            </div>
                            <!-- end card header -->
                                    ...
                                    <form id="searchForm">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>User ID</label>
                                                    <input type="text" class="form-control" name="user_id" id="user-id" placeholder="User ID" />
                                                </div>
                                            </div>
                            ...
                            <div class="card-body">
                                <div id="table-gridjs">
                                    <div class="table-responsive">
                                        <table id="downline-purchase-report" class="display nowrap table-striped" style="width: 100%">
                                            <thead>
                                            <tr>
                                                <th>Sr No.</th>
                                                <th>Date</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            let i = 0;
            var reportsTable = $("#downline-purchase-report").DataTable({
                responsive: true,
                lengthMenu: [
                    [10, 50, 100],
                    [10, 50, 100],
