                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header justify-content-between d-flex align-items-center">
                                <h4 class="card-title">Downline Purchase Report</h4>
                            </div>
                            <!-- end card header -->
                            ...
                            <div class="card-body">
                                <div id="table-gridjs">
                                    <div class="table-responsive">
                                        <table id="downline-purchase-report" class="display nowrap table-striped"
                                            style="width: 100%">
                                            <thead>
                                                <tr>
                                                    <th>Sr No.</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var reportsTable = $("#downline-purchase-report").DataTable({
                ...
                ajax: {
                    url: '{{ url('/get-downline-purchase-report') }}',
                    type: "POST",
                    data: function(d) {
                        i = 0;
                        i = d.start + 1;
