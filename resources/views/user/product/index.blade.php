...
<div class="page-wrapper">
    <div class="container-fluid">
                <div class="col-md-12 table-responsive">
                    <div class="row">
                        <div class="col-12">
                            <table id="topup-list" class="table table-bordered table-striped datatable">
                                <thead>
                                <tr>
                                    <th>Sr No</th>
{{--                                    <th>User</th>--}}
...
{{--                                    <th>Transaction Id</th>--}}
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var topUpTable = $('#topup-list').DataTable({
                processing: true,
                // serverSide: true,
                order: [0, 'DESC'],
                dom: 'Bfrtip',
                ...
                "columns": [
                    ...
                    // {data: 'today_date', name: 'today_date', orderable: false, searchable: false},
                    // {data: 'payment_mode', name: 'payment_mode', orderable: false, searchable: true}
                ]
            });
            topUpTable.buttons().container()
                .appendTo( '#topup-list_wrapper .col-md-6:eq(0)' );
        })
            </script>
@endsection
