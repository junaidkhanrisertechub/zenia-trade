...
@section('content')
                                        ...
                                        <div class="swiper-wrapper">
                                                ...
                                                <div class="card dash-product-box shadow-none border mb-0">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="dash-product-img">
                                                            <img src="{{asset('user-assets/images/product/img-1.png')}}" class="img-fluid"
                                                                alt="">
                                                        </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card dash-product-box shadow-none border mb-0">
                                                    <div class="card-body">
                                                        <div class="dash-product-img">
                                                            <img src="{{asset('user-assets/images/product/img-2.png')}}" class="img-fluid"
                                                                alt="">
                                                        </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card dash-product-box shadow-none border mb-0">
                                                    <div class="card-body">
                                                        <div class="dash-product-img">
                                                            <img src="{{asset('user-assets/images/product/img-3.png')}}" class="img-fluid"
                                                                alt="">
                                                        </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card dash-product-box shadow-none border mb-0">
                                                    <div class="card-body">
                                                        <div class="dash-product-img">
                                                            <img src="{{asset('user-assets/images/product/img-6.png')}}" class="img-fluid"
                                                                alt="">
                                                        </div>
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="dropdown">
                                            <a class="dropdown-toggle text-reset" href="#"
                                                ...
                                                <span class="fw-semibold">Year:</span> <span class="text-muted">2022<i
                                                        class="mdi mdi-chevron-down ms-1"></i></span>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-3">
                                                                <img src="{{asset('user-assets/images/users/avatar-1.jpg')}}" alt=""
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-3">
                                                                <img src="{{asset('user-assets/images/users/avatar-3.jpg')}}" alt=""
                                                                    class="avatar rounded-circle">
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-3">
                                                                <img src="{{asset('user-assets/images/users/avatar-5.jpg')}}" alt=""
                                                                    class="avatar rounded-circle">
                                                            </div>
    ...
    <script type="text/javascript">
        ...
        function drawMontlyBillingChart() {

            // Define the chart to be drawn.

            var data = google.visualization.arrayToDataTable([
                ['IncomeBy', 'Total Income'],
                ['Roi', {{ $arrData['roi_income'] }}],
                ['Direct', {{ $arrData['direct_income'] }}],
                ['Daily Binary', {{ $arrData['binary_income'] }}],
                ['HSCC Bonus', {{ $arrData['hscc_bonus_new'] }}],
            ]);
            var options = {
                title: '',
                vAxis: {
            ...
            var chart = new google.visualization.ColumnChart(document.getElementById('chart_line_sales'));
